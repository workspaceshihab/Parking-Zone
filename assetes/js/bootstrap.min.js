...
*/
  ...
  function Q(a) {
    a = void 0 === a ? {} : a; M.call(this); this.i = []; this.h = {}; this.D = this.g = 0; this.C = this.l = !1; this.u = []; this.A = this.F = !1; for (var b = n(oa), c = b.next(); !c.done; c = b.next())this.i[c.value] = []; this.j = 0; this.N = a.timeout || 1; this.o = na; this.m = 0; this.H = this.R.bind(this); this.M = this.T.bind(this); this.J = this.O.bind(this); this.K = this.P.bind(this); this.L = this.S.bind(this); if (b = !!window.requestIdleCallback && !!window.cancelIdleCallback) b = la("disable_scheduler_requestIdleCallback"), b = !("string" === typeof b && "false" ===
  ...
  function Ca(a, b, c) {
    if (!c) return c = void 0 === c, -ta(Z(), a, b, c); var d = window.setTimeout(function () { var e = ta(Z(), a, b); W[d] = e }, c);
    return d
  }
